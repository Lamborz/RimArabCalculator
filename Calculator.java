...
//                    //если число двухзначное, то узнаём из каких цифр остоит первое цисло
//                    if(line.substring(0,i).length() >=2){
//                        firstDigOfTheFirstRimNum = line.substring(0,1);
//
//                        secondDigOfTheFirstRimNum = line.substring(1,2);
//                        System.out.println(firstDigOfTheFirstRimNum+" , " + secondDigOfTheFirstRimNum);
//                    }
//
//                    //если второе число двухзначное, то узнаём из каких цифр остоит второе цисло
//                    if(line.substring(i + 1, line.length()).length() >= 2) {
//                        firstDigOfTheSecondRimNum  = line.substring(i + 1, line.length()).substring(0,1);
//                        int chekFirstNum = rimNums.convertRimToArab(firstDigOfTheSecondRimNum);
//                        String firstRimDigOfTheSecondRimNum = rimNums.convertingArabToRomeFromm10To100ForFirstArabDig(chekFirstNum);
//                        secondDigOfTheSecondRimNum  = line.substring(i + 1, line.length()).substring(1,2);
//                        int chekSecondNum = rimNums.convertRimToArab(secondDigOfTheSecondRimNum);
////                        String secondRimDigOfTheSecondRimNum =rimNums.convertArabToRim(chekSecondNum);
////                        System.out.println(firstRimDigOfTheSecondRimNum+" , " + secondRimDigOfTheSecondRimNum);
//                    }
                    rimFirst = line.substring(0, i);
                    rimSecond = line.substring(i + 1, line.length());
